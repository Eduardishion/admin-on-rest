...
var Admin = function Admin(_ref) {
    ...
    var store = (0, _redux.createStore)(reducer, initialState, (0, _redux.compose)((0, _redux.applyMiddleware)(sagaMiddleware, (0, _reactRouterRedux.routerMiddleware)(_reactRouter.hashHistory)), window.devToolsExtension ? window.devToolsExtension() : function (f) {
        return f;
    }));
